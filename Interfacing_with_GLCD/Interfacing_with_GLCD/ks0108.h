...
// Command Port Bits
#define R_W					0x01		// D/I Bit Number
#define EN					0x00		// R/W Bit Number
#define CSEL1				0x03		// EN Bit Number
#define CSEL2				0x04		// CS1 Bit Number
#define D_I				    0x02		// CS2 Bit Number
